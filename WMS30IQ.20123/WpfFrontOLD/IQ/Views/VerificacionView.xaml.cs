...
{
    /// <summary>
    /// Interaction logic for VerificacionView.xaml
    /// </summary>
    public partial class VerificacionView : UserControlBase, IVerificacionView
    {
        ...
        public VerificacionModel Model
        {
            get { return this.DataContext as VerificacionModel; }
    ...
    public interface IVerificacionView
    {
        //Clase Modelo
        VerificacionModel Model { get; set; }
