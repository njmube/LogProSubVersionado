...
{
    /// <summary>
    /// Interaction logic for ShippingMethodView.xaml
    /// </summary>
    public partial class ShippingMethodView : UserControlBase, IShippingMethodView
    {
        ...
        public event EventHandler<DataEventArgs<ShippingMethod>> LoadData;
        public event EventHandler<EventArgs> Save;
        public event EventHandler<EventArgs> Delete;

         public ShippingMethodModel Model
        {
            get
            { return this.DataContext as ShippingMethodModel; }
            set
        ...
        {
            LoadData(sender, new DataEventArgs<ShippingMethod>((ShippingMethod)dgList.SelectedItem));
    ...
    {
        //Clase Modelo
        ShippingMethodModel Model { get; set; }
        ...
        event EventHandler<DataEventArgs<ShippingMethod>> LoadData;
