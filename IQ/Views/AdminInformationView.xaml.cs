...
{
    /// <summary>
    /// Interaction logic for AdminInformationView.xaml
    /// </summary>
    public partial class AdminInformationView : UserControlBase, IAdminInformationView
    {
        ...
        public AdminInformationModel Model
        {
            get
            { return this.DataContext as AdminInformationModel; }
            set
    ...
    public interface IAdminInformationView
    {
        //Clase Modelo
        AdminInformationModel Model { get; set; }
