...
namespace ServiceConsole
{
    ...
    public class ProjectInstaller : Installer
    {
        ...
        private void InitializeComponent()
        {
            ...
            // srvcInstaller
            // 
            this.srvcInstaller.ServiceName = "WMS 3.0 Schedule Service";
            this.srvcInstaller.Description = "Run Schedules for WMS Integration Process.";
            this.srvcInstaller.DisplayName = "WMS 3.0 Schedule Service";
            this.srvcInstaller.StartType = System.ServiceProcess.ServiceStartMode.Automatic;

            // 
            // ProjectInstaller
            // 
            this.Installers.AddRange(new System.Configuration.Install.Installer[] { this.spInstaller, this.srvcInstaller });
        ...
        {
            ServiceController sc = new ServiceController("WMS 3.0 Schedule Service");
            sc.Start();
        }
