...
namespace WpfFront.Common.WFUserControls
{
    ...
    /// </summary>
    public partial class WFStringText : UserControl, INotifyPropertyChanged
    {
        public WFStringText()
        {
            InitializeComponent();
        ...
        public static DependencyProperty UcLabelProperty = DependencyProperty.Register("UcLabel", typeof(String), typeof(WFStringText));
        ...
        public static DependencyProperty UcValueProperty = DependencyProperty.Register("UcValue", typeof(String), typeof(WFStringText));
