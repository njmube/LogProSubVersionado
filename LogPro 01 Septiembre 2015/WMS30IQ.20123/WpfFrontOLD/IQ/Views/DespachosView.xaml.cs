...
{
    /// <summary>
    /// Interaction logic for DespachosView.xaml
    /// </summary>
    public partial class DespachosView : UserControlBase, IDespachosView
    {
        #region Header
        ...
        public DespachosModel Model
        {
            get
            { return this.DataContext as DespachosModel; }
            set
    ...
    public interface IDespachosView
    {
        //Clase Modelo
        DespachosModel Model { get; set; }
