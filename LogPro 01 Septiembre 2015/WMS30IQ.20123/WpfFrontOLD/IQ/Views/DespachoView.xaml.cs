...
{
    /// <summary>
    /// Interaction logic for DespachoView.xaml
    /// </summary>
    public partial class DespachoView : UserControlBase, IDespachoView
    {
        ...
        public event EventHandler<EventArgs> ActualizarRegistrosDespachos;
        ...
        public DespachoModel Model
        {
            get { return this.DataContext as DespachoModel; }
        ...
        private void btn_ActualizarDespachos_Click_1(object sender, RoutedEventArgs e)
        {
            ActualizarRegistrosDespachos(sender, e);
        }
    ...
    public interface IDespachoView
    {
        //Clase Modelo
        DespachoModel Model { get; set; }
        ...
        event EventHandler<EventArgs> ActualizarRegistrosDespachos;
