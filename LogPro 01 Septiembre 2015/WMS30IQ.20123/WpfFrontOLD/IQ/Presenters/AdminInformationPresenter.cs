...
namespace WpfFront.Presenters
{
    ...
    public interface IAdminInformationPresenter
    {
       IAdminInformationView View { get; set; }
       ToolWindow Window { get; set; }
    }


    public class AdminInformationPresenter : IAdminInformationPresenter
    {
        public IAdminInformationView View { get; set; }
        ...
        private void OnLoadData(object sender, DataEventArgs<ClassEntity> e)
        {
            ...
            if (e.Value.ClassEntityID == EntityID.Label)
            {
                ...
                //Muestro el boton de eliminar label
                View.GetButtonAnular.Visibility = Visibility.Visible;
            }
