...
{
    /// <summary>
    /// Interaction logic for EmpaqueDTVView.xaml
    /// </summary>
    public partial class EmpaqueDTVView : UserControlBase, IEmpaqueDTVView
    {
        ...
        public EmpaqueDTVModel Model
        {
            get { return this.DataContext as EmpaqueDTVModel; }
    ...
    public interface IEmpaqueDTVView
    {
        //Clase Modelo
        EmpaqueDTVModel Model { get; set; }
