...
namespace WpfFront.Models
{
    ...
    public interface IKitAssemblyV2Model
    {
        ...
        //Seriales utilizados
        IList<Label> SerialesUtilizados { get; set; }

    }

    public class KitAssemblyV2Model : BusinessEntityBase, IKitAssemblyV2Model
    {
        ...
        private IList<Label> _SerialesUtilizados;
        public IList<Label> SerialesUtilizados
        {
            get { return _SerialesUtilizados; }
            set
            {
                _SerialesUtilizados = value;
                OnPropertyChanged("SerialesUtilizados");
            }
        }
