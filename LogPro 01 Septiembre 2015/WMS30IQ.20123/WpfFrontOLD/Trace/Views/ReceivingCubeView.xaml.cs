...
namespace WpfFront.Views
{
    ...
    /// </summary>
    public partial class ReceivingCubeView : UserControlBase, IReceivingCubeView
    {

        private readonly PivotView pivotView = new PivotView();

        public ReceivingCubeView()
        {
            InitializeComponent();
        }


        public ReceivingCubeModel Model
        {
            get
            { return this.DataContext as ReceivingCubeModel; }
            set
        ...
        private void LoadPivotLayout() {
            ...
            Path.GetDirectoryName(Assembly.GetEntryAssembly().Location), "ReceivingSettings.xml");
    ...
    public interface IReceivingCubeView
    {
        //Clase Modelo
        ReceivingCubeModel Model { get; set; }
