...
{
    /// <summary>
    /// Interaction logic for KitAssemblyView.xaml
    /// </summary>
    public partial class KitAssemblyView : UserControlBase, IKitAssemblyView
    {
        public KitAssemblyView()
        {
            InitializeComponent();
        ...
        public KitAssemblyModel Model
        {
            get
            { return this.DataContext as KitAssemblyModel; }
            set
    ...
    public interface IKitAssemblyView
    {
        //Clase Modelo
        KitAssemblyModel Model { get; set; }
