...
namespace WpfFront.Views
{
    ...
    /// </summary>
    public partial class ProductCategoryView : UserControlBase, IProductCategoryView
    {
        ...
        public event EventHandler<DataEventArgs<ProductCategory>> LoadData;
        public event EventHandler<EventArgs> Save;
        public event EventHandler<EventArgs> Delete;

         public ProductCategoryModel Model
        {
            get
            { return this.DataContext as ProductCategoryModel; }
            set
        ...
        {
            LoadData(sender, new DataEventArgs<ProductCategory>((ProductCategory)dgList.SelectedItem));
    ...
    {
        //Clase Modelo
        ProductCategoryModel Model { get; set; }
        ...
        event EventHandler<DataEventArgs<ProductCategory>> LoadData;
